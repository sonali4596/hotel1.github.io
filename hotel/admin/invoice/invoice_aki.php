...
$pdf->Cell(100,5,'near uttarahlli circle ',0,0,'L');
$pdf->Cell(90,5,'Invoice Id :     '.$invoice_id,0,1,'R');

$pdf->Cell(100,5,'padmanabhanagar',0,0,'L');
$pdf->Cell(90,5,'',0,1,'R');

$pdf->Cell(100,5,'karnataka' 560070',0,1,'L');
$pdf->Cell(100,5,'Tel No : 1234567890',0,1,'L');
